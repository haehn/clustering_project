...
WRITEDIR=/ebi/research/goldman/kevin/bionjreg2/$2/sim$1
...
python $PICKLE -d $WRITEDIR -g $GTP_PATH -p $3 -m $4 -n $5 -data $6 -t $TEMPORARY_DIRECTORY

bsub -q research-rh6 -o /dev/null bash $TMPWRAP python $ANALYSE -d geo -c all      -i $WRITEDIR -p $3 -m $4 -n $5 -data $6
bsub -q research-rh6 -o /dev/null bash $TMPWRAP python $ANALYSE -d euc -c all      -i $WRITEDIR -p $3 -m $4 -n $5 -data $6
bsub -q research-rh6 -o /dev/null bash $TMPWRAP python $ANALYSE -d sym -c all      -i $WRITEDIR -p $3 -m $4 -n $5 -data $6
