...
single_tree_files = glob.glob( "{0}/trees/besttrees/*".format(INPUT_DIR) )
...
cluster_tree_files = glob.glob( "{0}/clusters/trees/besttrees/*".format(INPUT_DIR) )
...
true_tree_files = glob.glob( "{0}/trees/*_sps.nwk".format(INPUT_DIR))
