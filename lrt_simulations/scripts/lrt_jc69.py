...
print 'getting trees...'
col.put_trees_parallel(program='phyml', model='JC69', datatype='nt',
...
col.put_partitions(metrics=['sym'], linkages=['ward'],
                   nclasses=range(1, 21))
col.put_clusters()
col.put_cluster_trees_parallel(program='phyml', model='JC69',
                               datatype='nt', ncat=1, tmpdir=tmpdir)

cPickle.dump(col, file('yeast_jc69.pickle', 'w'))
