...
desc       = 'Read in a SequenceCollection from disk and dump a randomised copy'
...
parser.add_argument('-o', dest='output_file', help=output_dir, type=str)
