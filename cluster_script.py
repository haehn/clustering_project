...
if not os.path.exists("{}/concats".format(INPUT_DIR)): os.mkdir("{}/concats".format(INPUT_DIR))
if not os.path.exists("{}/concats/besttrees".format(INPUT_DIR)): os.mkdir("{}/concats/besttrees".format(INPUT_DIR))
if not os.path.exists("{}/concats/info".format(INPUT_DIR)): os.mkdir("{}/concats/info".format(INPUT_DIR))

true1_treeobject = dendropy.Tree()
true1_treeobject.read_from_path("{}/trees/true1_sps.nwk".format(INPUT_DIR),'newick',taxon_set=taxa)
